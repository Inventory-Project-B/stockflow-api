...
router.post("/login",
  validate([
    body('email')
      .notEmpty().withMessage('Email/Username wajib diisi'),
    body('password')
      .notEmpty().withMessage('Password wajib diisi')
  ]),
  login
...
router.put("/profile",
  ...
  validate([
    ...
    body('currentPassword')
      ...
      .notEmpty().withMessage('Password saat ini wajib diisi untuk mengubah password'),
    body('password')
      .optional()
      .isLength({ min: 8 }).withMessage('Password minimal 8 karakter')
  ]),
...
router.put("/users/:id",
  ...
  validate([
    ...
    body('username')
      ...
      .matches(/^[a-zA-Z0-9_]+$/).withMessage('Username hanya boleh berisi huruf, angka dan underscore'),
    body('email').optional().isEmail().withMessage('Email tidak valid'),
    body('role').optional().isIn(['admin', 'pegawai']).withMessage('Role tidak valid')
  ]),
  updateUser
);
